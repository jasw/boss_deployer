...
cli.l( longOpt: 'libjarpath', argName: 'libjarpath', required: false, args: 1, 'folder path that contains all of the dependent jars' )
...
def LIB_JAR_PATH = new File(libJarPath)
//--------------------------------------------------------------------------
...
ant.jar( destfile: destFile, compress: true, index: true ) {
    ...
    zipgroupfileset( dir: LIB_JAR_PATH, includes: '*.jar' )
    // add more jars here
